...
// bool succeed = 2;
inline void RegisterResponse::clear_succeed() {
  _impl_.succeed_ = false;
}
inline bool RegisterResponse::_internal_succeed() const {
  return _impl_.succeed_;
}
inline bool RegisterResponse::succeed() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.succeed)
  return _internal_succeed();
}
inline void RegisterResponse::_internal_set_succeed(bool value) {
  
  _impl_.succeed_ = value;
}
inline void RegisterResponse::set_succeed(bool value) {
  _internal_set_succeed(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterResponse.succeed)
}
