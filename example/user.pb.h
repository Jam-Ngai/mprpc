...
class ResultCode final :
 ...
 public:
  ...
  void set_errms(ArgT0&& arg0, ArgT... args);
  std::string* mutable_errms();
  PROTOBUF_NODISCARD std::string* release_errms();
  void set_allocated_errms(std::string* errms);
  private:
  const std::string& _internal_errms() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_errms(const std::string& value);
...
class LoginRequest final :
 ...
 public:
  ...
  // bytes passwprd = 2;
  void clear_passwprd();
  const std::string& passwprd() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_passwprd(ArgT0&& arg0, ArgT... args);
  std::string* mutable_passwprd();
  PROTOBUF_NODISCARD std::string* release_passwprd();
  void set_allocated_passwprd(std::string* passwprd);
  private:
  const std::string& _internal_passwprd() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_passwprd(const std::string& value);
  std::string* _internal_mutable_passwprd();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr passwprd_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_user_2eproto;
...
// bytes errms = 2;
inline void ResultCode::clear_errms() {
  _impl_.errms_.ClearToEmpty();
}
inline const std::string& ResultCode::errms() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errms)
  return _internal_errms();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResultCode::set_errms(ArgT0&& arg0, ArgT... args) {
 
 _impl_.errms_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errms)
}
inline std::string* ResultCode::mutable_errms() {
  std::string* _s = _internal_mutable_errms();
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.errms)
  return _s;
}
inline const std::string& ResultCode::_internal_errms() const {
  return _impl_.errms_.Get();
}
inline void ResultCode::_internal_set_errms(const std::string& value) {
  
  _impl_.errms_.Set(value, GetArenaForAllocation());
}
inline std::string* ResultCode::_internal_mutable_errms() {
  
  return _impl_.errms_.Mutable(GetArenaForAllocation());
}
inline std::string* ResultCode::release_errms() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.errms)
  return _impl_.errms_.Release();
}
inline void ResultCode::set_allocated_errms(std::string* errms) {
  if (errms != nullptr) {
    
  } else {
    
  }
  _impl_.errms_.SetAllocated(errms, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.errms_.IsDefault()) {
    _impl_.errms_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.errms)
}
...
// bytes passwprd = 2;
inline void LoginRequest::clear_passwprd() {
  _impl_.passwprd_.ClearToEmpty();
}
inline const std::string& LoginRequest::passwprd() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequest.passwprd)
  return _internal_passwprd();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginRequest::set_passwprd(ArgT0&& arg0, ArgT... args) {
 
 _impl_.passwprd_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.LoginRequest.passwprd)
}
inline std::string* LoginRequest::mutable_passwprd() {
  std::string* _s = _internal_mutable_passwprd();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRequest.passwprd)
  return _s;
}
inline const std::string& LoginRequest::_internal_passwprd() const {
  return _impl_.passwprd_.Get();
}
inline void LoginRequest::_internal_set_passwprd(const std::string& value) {
  
  _impl_.passwprd_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginRequest::_internal_mutable_passwprd() {
  
  return _impl_.passwprd_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginRequest::release_passwprd() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRequest.passwprd)
  return _impl_.passwprd_.Release();
}
inline void LoginRequest::set_allocated_passwprd(std::string* passwprd) {
  if (passwprd != nullptr) {
    
  } else {
    
  }
  _impl_.passwprd_.SetAllocated(passwprd, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.passwprd_.IsDefault()) {
    _impl_.passwprd_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRequest.passwprd)
}
...
// bool succeed = 2;
inline void LoginResponse::clear_succeed() {
  _impl_.succeed_ = false;
}
inline bool LoginResponse::_internal_succeed() const {
  return _impl_.succeed_;
}
inline bool LoginResponse::succeed() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.succeed)
  return _internal_succeed();
}
inline void LoginResponse::_internal_set_succeed(bool value) {
  
  _impl_.succeed_ = value;
}
inline void LoginResponse::set_succeed(bool value) {
  _internal_set_succeed(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.succeed)
}
