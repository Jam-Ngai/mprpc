...
PROTOBUF_CONSTEXPR ResultCode::ResultCode(
    ...
    /*decltype(_impl_.errms_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
PROTOBUF_CONSTEXPR LoginRequest::LoginRequest(
  ...
  , /*decltype(_impl_.passwprd_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, _impl_.errms_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginRequest, _impl_.passwprd_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.succeed_),
};
...
void ResultCode::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_errms().empty()) {
    _this->_internal_set_errms(from._internal_errms());
  }
...
void ResultCode::InternalSwap(ResultCode* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.errms_, lhs_arena,
      &other->_impl_.errms_, rhs_arena
  );
...
LoginRequest::LoginRequest(const LoginRequest& from)
  ...
  _impl_.passwprd_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.passwprd_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_passwprd().empty()) {
    _this->_impl_.passwprd_.Set(from._internal_passwprd(), 
      _this->GetArenaForAllocation());
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_passwprd();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* LoginRequest::_InternalSerialize(
  ...
  // bytes passwprd = 2;
  if (!this->_internal_passwprd().empty()) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_passwprd(), target);
  }
...
void LoginRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_passwprd().empty()) {
    _this->_internal_set_passwprd(from._internal_passwprd());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void LoginRequest::InternalSwap(LoginRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.passwprd_, lhs_arena,
      &other->_impl_.passwprd_, rhs_arena
  );
}
...
void LoginResponse::InternalSwap(LoginResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(LoginResponse, _impl_.succeed_)
      + sizeof(LoginResponse::_impl_.succeed_)
